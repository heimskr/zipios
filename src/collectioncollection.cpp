...
namespace zipios {
	...
	namespace {
		 ...
		 */
		void matchEntry(
			CollectionCollection::vector_t collections, std::string const &name, FileEntry::pointer_t &cep, FileCollection::pointer_t &file_collection, CollectionCollection::MatchPath matchpath) {
	 ...
	 */
	CollectionCollection::CollectionCollection(CollectionCollection const &rhs) : FileCollection(rhs) {
