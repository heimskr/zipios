...
namespace zipios {
	 ...
	 */
	InflateInputStreambuf::InflateInputStreambuf(std::streambuf *inbuf, offset_t start_pos) : FilterInputStreambuf(inbuf), m_outvec(getBufferSize()), m_invec(getBufferSize()) {
